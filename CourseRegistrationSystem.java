...
public class CourseRegistrationSystem {
    ...
    public void registerStudent() {
        System.out.println("Enter student 10:");
        ...
        if (course != null) {
            if (!course.isFull()) {
                ...
                if (student != null) {
                    ...
                    System.out.println(
                            "Student " + student.getName() + " registered for course " + course.getTitle() + ".");
                } else {
                    System.out.println("Student not found.");
                }
            } else {
        ...
        if (student != null) {
            ...
            if (course != null) {
                if (student.getRegisteredCourses().contains(course)) {
                    ...
                    System.out
                            .println("Student " + student.getName() + "dropped from course " + course.getTitle() + ".");
                } else {
